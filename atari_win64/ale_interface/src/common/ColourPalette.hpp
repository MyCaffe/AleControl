...
class ColourPalette {
    ...
    public:
        ...
        /**
            ...
            8 bits => 24 bits
         */
		void ColourPalette::applyPaletteRGB(uInt8 px, uInt8* pxR, uInt8* pxG, uInt8* pxB)
		{
			int rgb = m_palette[px];
			*pxR = (unsigned char)((rgb >> 16));
			*pxG = (unsigned char)((rgb >> 8));
			*pxB = (unsigned char)((rgb >> 0));
		}
        ...
        /**
            ...
            8 bits => 8 bits
         */
		void ColourPalette::applyPaletteGrayscale(uInt8 px, uInt8* pxG)
		{
			int rgb = m_palette[px];
			*pxG = (unsigned char)((rgb & 0xFF));
		}
